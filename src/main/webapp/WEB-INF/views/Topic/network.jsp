...
<div class="main-container">
    <div class="middle expand-show">
        ...
        <div class="hi-icon-wrap hi-icon-effect-8">
        	  <input type="button"  class="hi-icon hi-icon-archive" onclick="entity_network()" />
        </div>
    </div>
...
<nav class="menu menu--valentine">
    <ul class="pages-nav menu__list">
        ...
        <li class="pages-nav__item menu__item menu__item--current"><a class="menu__link link link--page" href="kejso/Topic/network">实体关系网络</a></li>
...
<script>
   ...
   function  entity_network()
   {
	...
	option = {
		...
		legend : {
			x : 'left',
			data : [ 'Cause', 'Describe', 'From', 'Identity', 'Medicine','Part','Position','Central Entity' ]
		},
		series : [ {
			type : 'force',
			name : "实体关系图",
